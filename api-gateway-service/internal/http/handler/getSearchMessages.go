...
import (
	...
	searchbotchatclient "repairCopilotBot/search-bot/pkg/client/chat"
	"time"
)

type GetSearchMessagesResponse struct {
	Messages []searchbotchatclient.Message `json:"messages"`
}

func GetSearchMessagesHandler(
	log *slog.Logger,
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		messages, err := searchBotClient.Chat.GetMessages(ctx, chatID)
		if err != nil {
		...
		// Формируем ответ
		response := GetSearchMessagesResponse{
			Messages: messages,
		}
