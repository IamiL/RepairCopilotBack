...
const (
	ChatService_CreateNewMessage_FullMethodName = "/search.v1.ChatService/CreateNewMessage"
	ChatService_GetChats_FullMethodName         = "/search.v1.ChatService/GetChats"
	ChatService_GetMessages_FullMethodName      = "/search.v1.ChatService/GetMessages"
	ChatService_FinishChat_FullMethodName       = "/search.v1.ChatService/FinishChat"
)
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "search.v1.ChatService",
	...
	Metadata: "search-bot/api/proto/search/v1/search.proto",
}

const (
	UserService_CreateNewUser_FullMethodName = "/search.v1.UserService/CreateNewUser"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "search.v1.UserService",
