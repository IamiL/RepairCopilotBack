...
// ChangeUserRoleRequest запрос для смены роли пользователя
type ChangeUserRoleRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`     // UUID пользователя
	IsAdmin       bool                   `protobuf:"varint,2,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // true для роли admin, false для роли user
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChangeUserRoleRequest) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
// ChangeUserRoleResponse ответ на смену роли
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x10inspections_left\x18\x01 \x01(\rR\x0finspectionsLeft\"K\n" +
